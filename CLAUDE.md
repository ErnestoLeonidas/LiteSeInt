...
6. Update the visible version in `index.html` only if the phase is actually complete. The version trail across `index.html`, `CHANGELOG.md`, and the git tags (e.g. `v.0.8.2`) should move together — do not bump one without the others.
