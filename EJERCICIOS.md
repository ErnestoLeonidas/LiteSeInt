...
Esta tabla rastrea qué módulos del lenguaje LiteSeInt cubre la guía. A `v0.9.2`, todos los conceptos principales tienen ejercicios adaptados, visibles y cubiertos por pruebas del banco o de documentación interna.
